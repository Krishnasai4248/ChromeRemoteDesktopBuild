...
**Telemetry**: Run: `polaris telemetry record accept --feature <slug> --phase start --agent claude`
...
**Telemetry**: Run: `polaris telemetry record accept --feature <slug> --phase complete --agent claude`
